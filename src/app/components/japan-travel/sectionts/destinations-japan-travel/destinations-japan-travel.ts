...
export class DestinationsJapanTravel {
  destinations: Destination[] = [
    {
      ...
      description: 'Una capitale come poche altre. La sua dimensione e le sue megastrutture convivono con la calma e l\'ordine del vissuto quotidiano.',
    ...
    },
    {
      ...
      description: 'La città d\'arte del Giappone per definizione. Templi e scorci tradizionali ad ogni passo.',
    ...
    },
    {
      ...
      description: 'Il castello, Dotonbori e lo street food più famoso del Giappone.',
    ...
    },
    {
      ...
      description: 'Il Memoriale della Pace e il torii galleggiante più iconico del Giappone.',
    ...
    },
    {
      ...
      description: 'L\'antica capitale con il Todaiji e i famosi cervi nel parco.',
    ...
    },
    {
      ...
      description: 'Quartiere dei samurai, mercato del pesce e il giardino Kenrokuen.',
    ...
    },
    {
      ...
      description: 'Santuari magnifici e natura spettacolare tra montagne e cascate.',
    ...
    },
    {
      ...
      description: 'Villaggio di montagna con atmosfera tradizionale preservata.',
      image: 'https://images.unsplash.com/photo-1590559899731-a382839e5549?w=600&q=80',
    ...
    },
    {
      ...
      description: 'Isole subtropicali con spiagge paradisiache e cultura unica.',
    ...
    },
    {
      ...
      description: 'Olimpiadi invernali, templi e le famose scimmie nei bagni termali.',
      image: 'https://images.unsplash.com/photo-1528164344705-47542687000d?w=600&q=80',
  ...
  get displayedDestinations(): Destination[] {
    return this.showAll ? this.destinations : this.destinations.filter(d => d.popular);
  }
